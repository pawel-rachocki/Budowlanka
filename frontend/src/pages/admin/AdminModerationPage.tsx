    ...
    <div className="p-6 lg:p-8">
      ...
      >
        <Dialog.Portal>
          ...
          <Dialog.Content className="relative fixed left-1/2 top-1/2 z-50 w-full max-w-md -translate-x-1/2 -translate-y-1/2 rounded-2xl bg-surface-card p-6 shadow-xl focus:outline-none">
