---
name: write-tests
description: "Pisanie testów jednostkowych i integracyjnych. Użyj po implementacji serwisu/controllera lub gdy trzeba pokryć istniejący kod testami."
---
...
- Nazwy: `should_returnExpectedResult_when_condition()`
