...
├── auth/            — JWT (Nimbus JOSE), rejestracja, weryfikacja email
...
Używamy Nimbus JOSE JWT (wbudowany w Spring Security, brak dodatkowych zależności).
Nie używamy jjwt — nie jest kompatybilny z Jackson 3.x (Spring Boot 4.x).
